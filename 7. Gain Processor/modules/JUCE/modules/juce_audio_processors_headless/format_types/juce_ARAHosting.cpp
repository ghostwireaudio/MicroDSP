...
ARAHostModel::PlugInExtensionInstance ARAHostDocumentController::bindDocumentToPluginInstance (GainProcessorInstance& instance,
                                                                                               ARA::ARAPlugInInstanceRoleFlags knownRoles,
                                                                                               ARA::ARAPlugInInstanceRoleFlags assignedRoles)
{
...
void createARAFactoryAsync (GainProcessorInstance& instance, std::function<void (ARAFactoryWrapper)> cb)
{
