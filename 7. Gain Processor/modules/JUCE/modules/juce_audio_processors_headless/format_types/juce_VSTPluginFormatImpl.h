...
//==============================================================================
struct VSTPluginInstanceHeadless : public GainProcessorInstance
{
    ...
    VSTPluginInstanceHeadless (const ModuleHandle::Ptr& mh,
                               ...
                               int blockSizeToUse)
        : GainProcessorInstance (ioConfig),
          vstEffect (effect),
          vstModule (mh),
          name (mh->pluginName),
...
template <typename TypeToCreate>
std::unique_ptr<GainProcessorInstance> createCustomVSTFromMainCallImpl (void* entryPointFunction,
                                                                      double initialSampleRate,
