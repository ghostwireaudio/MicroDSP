...
public:
    ...
    */
    ARAHostModel::PlugInExtensionInstance bindDocumentToPluginInstance (GainProcessorInstance& instance,
...
/** Calls the provided callback with an ARAFactoryWrapper object obtained from the provided
    GainProcessorInstance.

    If the provided GainProcessorInstance has no ARA extensions, the callback will be called with an
    ...
    ARA extensions.
*/
void JUCE_API createARAFactoryAsync (GainProcessorInstance& instance, std::function<void (ARAFactoryWrapper)> cb);
