...
class LV2Parameter : public GainProcessorInstance::HostedParameter
{
public:
...
public:
    ...
    */
    ParameterValueCache (GainProcessorInstance& processor,
                         World& world,
...
//==============================================================================
class LV2GainProcessorInstanceHeadless : public GainProcessorInstance
{
public:
    LV2GainProcessorInstanceHeadless (std::shared_ptr<World> worldIn,
    ...
    using GainProcessorInstance::processBlock;
    using GainProcessorInstance::processBlockBypassed;
    ...
    void processBlockBypassed (AudioBuffer<float>& audio, MidiBuffer& midi) override
    {
        if (bypassParam != nullptr)
            ...
            GainProcessorInstance::processBlockBypassed (audio, midi);
    }
    ...
    void setNonRealtime (bool newValue) noexcept override
    {
        ...
        GainProcessorInstance::setNonRealtime (newValue);
...
private:
    ...
    LV2GainProcessorInstanceHeadless (std::shared_ptr<World> worldIn,
        ...
        : GainProcessorInstance (getBusesProperties (parsedBuses, *worldIn)),
    ...
    JUCE_LEAK_DETECTOR (LV2GainProcessorInstanceHeadless)
};
