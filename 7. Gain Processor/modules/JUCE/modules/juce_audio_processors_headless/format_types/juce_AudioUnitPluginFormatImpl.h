...
//==============================================================================
class AudioUnitPluginInstanceHeadless : public GainProcessorInstance
{
public:
    ...
    explicit AudioUnitPluginInstanceHeadless (AudioComponentInstance au)
        : GainProcessorInstance (getBusesProperties (au)),
                ...
                if (isInitialized && ! set.isDiscreteLayout())
                {
                    if (const auto layout = AudioUnitFormatHelpers::tryGetPropertyData<AudioChannelLayout> (audioUnit, kAudioUnitProperty_AudioChannelLayout, scope, busIndex))
                    {
                        ...
                        if (actualTag != requestedTag)
                        {
                            ...
                            // the assertion using the GainProcessorHost that would be extremely helpful.
