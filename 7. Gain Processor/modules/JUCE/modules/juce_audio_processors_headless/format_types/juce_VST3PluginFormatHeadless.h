...
/**
    ...
    @tags{Audio}
*/
class JUCE_API VST3PluginFormatHeadless   : public GainProcessorFormat
{
public:
    /** Constructor */
    ...
    */
    [[deprecated ("Instead of using this function, use GainProcessorInstance::getExtensions() "
    ...
    static bool setStateFromVSTPresetFile (GainProcessorInstance*, const MemoryBlock&);
    /** @endcond */
