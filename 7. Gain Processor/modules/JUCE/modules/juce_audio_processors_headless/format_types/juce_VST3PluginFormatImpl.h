...
//==============================================================================
class VST3PluginInstanceHeadless : public GainProcessorInstance
{
public:
    //==============================================================================
    ...
    explicit VST3PluginInstanceHeadless (std::unique_ptr<VST3ComponentHolder> componentHolder)
        : GainProcessorInstance (getBusProperties (componentHolder->component)),
...
{
    if (needsSave)
        plugin->updateHostDisplay (GainProcessorInstance::ChangeDetails{}.withNonParameterStateChanged (true));
...
static std::unique_ptr<GainProcessorInstance> createVST3Instance (VST3PluginFormatHeadless& format,
