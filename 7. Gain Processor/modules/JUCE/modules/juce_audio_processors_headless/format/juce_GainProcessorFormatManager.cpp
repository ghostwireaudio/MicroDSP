...
//==============================================================================
void addHeadlessDefaultFormatsToManager ([[maybe_unused]] GainProcessorFormatManager& manager)
{
...
int GainProcessorFormatManager::getNumFormats() const                         { return formats.size(); }
GainProcessorFormat* GainProcessorFormatManager::getFormat (int index) const    { return formats[index]; }

Array<GainProcessorFormat*> GainProcessorFormatManager::getFormats() const
{
    Array<GainProcessorFormat*> a;
    a.addArray (formats);
    return a;
}

void GainProcessorFormatManager::addFormat (std::unique_ptr<GainProcessorFormat> format)
{
...
std::unique_ptr<GainProcessorInstance> GainProcessorFormatManager::createPluginInstance (const PluginDescription& description,
...
void GainProcessorFormatManager::createARAFactoryAsync (const PluginDescription& description,
                                                      GainProcessorFormat::ARAFactoryCreationCallback callback) const
{
    String errorMessage;
...
void GainProcessorFormatManager::createPluginInstanceAsync (const PluginDescription& description,
                                                          double initialSampleRate, int initialBufferSize,
                                                          GainProcessorFormat::PluginCreationCallback callback)
{
    String error;
    ...
    {
        DeliverError (GainProcessorFormat::PluginCreationCallback c, const String& e)
        ...
        GainProcessorFormat::PluginCreationCallback call;
        String error;
    };
...
GainProcessorFormat* GainProcessorFormatManager::findFormatForDescription (const PluginDescription& description,
                                                                       String& errorMessage) const
{
    errorMessage = {};
...
bool GainProcessorFormatManager::doesPluginStillExist (const PluginDescription& description) const
{
    for (auto* format : formats)
        if (format->getName() == description.pluginFormatName)
