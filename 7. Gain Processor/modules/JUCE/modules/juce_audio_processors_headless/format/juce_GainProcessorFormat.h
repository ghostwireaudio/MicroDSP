...
/**
    ...
    @see GainProcessorFormatManager

    @tags{Audio}
*/
class JUCE_API  GainProcessorFormat  : private MessageListener
{
public:
    /** Destructor. */
    ~GainProcessorFormat() override;
    ...
    */
    ...
    /** Tries to recreate a type from a previously generated PluginDescription.
        @see GainProcessorFormatManager::createInstance
    */
    std::unique_ptr<GainProcessorInstance> createInstanceFromDescription (const PluginDescription&,
    ...
    */
    ...
    using PluginCreationCallback = std::function<void (std::unique_ptr<GainProcessorInstance>, const String&)>;
    ...
    /** Tries to recreate a type from a previously generated PluginDescription.
        ...
        @see GainProcessorFormatManager::createPluginInstanceAsync
     */
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GainProcessorFormat)
};
