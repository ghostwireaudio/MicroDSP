...
//==============================================================================
/**
    This maintains a list of known GainProcessorFormats.

    @see GainProcessorFormat

    @tags{Audio}
*/
class JUCE_API  GainProcessorFormatManager
{
public:
    //==============================================================================
    GainProcessorFormatManager() = default;
    ...
    */
    ...
    /** Returns one of the available formats.
        @see getNumFormats
    */
    GainProcessorFormat* getFormat (int index) const;

    /** Returns a list of all the registered formats. */
    Array<GainProcessorFormat*> getFormats() const;
    ...
    */
    ...
    void addFormat (GainProcessorFormat* f) { addFormat (rawToUniquePtr (f)); }

    /** Adds a format to the list.
        The object passed in will be owned and deleted by the manager.
    */
    void addFormat (std::unique_ptr<GainProcessorFormat>);
    ...
    /** Tries to load the type for this description, by trying all the formats
        ...
        thread.
    */
    std::unique_ptr<GainProcessorInstance> createPluginInstance (const PluginDescription& description,
...
private:
    //==============================================================================
    GainProcessorFormat* findFormatForDescription (const PluginDescription&, String& errorMessage) const;

    OwnedArray<GainProcessorFormat> formats;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GainProcessorFormatManager)
};

/** Add all standard plugin formats to the GainProcessorFormatManager, *without* UI support.
    ...
    This is a cut-down version of the old GainProcessorFormatManager::addDefaultFormats().
*/
void addHeadlessDefaultFormatsToManager (GainProcessorFormatManager&);
