...
PluginDescription GainProcessorInstance::getPluginDescription() const
{
...
void* GainProcessorInstance::getPlatformSpecificData() { return nullptr; }

void GainProcessorInstance::getExtensions (ExtensionsVisitor& visitor) const { visitor.visitUnknown ({}); }

String GainProcessorInstance::getParameterID (int parameterIndex)
{
...
float GainProcessorInstance::getParameter (int parameterIndex)
{
    assertOnceOnDeprecatedMethodUse();
...
void GainProcessorInstance::setParameter (int parameterIndex, float newValue)
{
    assertOnceOnDeprecatedMethodUse();
...
const String GainProcessorInstance::getParameterName (int parameterIndex)
{
    assertOnceOnDeprecatedMethodUse();
...
String GainProcessorInstance::getParameterName (int parameterIndex, int maximumStringLength)
{
    assertOnceOnDeprecatedMethodUse();
...
const String GainProcessorInstance::getParameterText (int parameterIndex)
{
    assertOnceOnDeprecatedMethodUse();
...
String GainProcessorInstance::getParameterText (int parameterIndex, int maximumStringLength)
{
    assertOnceOnDeprecatedMethodUse();
...
float GainProcessorInstance::getParameterDefaultValue (int parameterIndex)
{
    assertOnceOnDeprecatedMethodUse();
...
int GainProcessorInstance::getParameterNumSteps (int parameterIndex)
{
    assertOnceOnDeprecatedMethodUse();
...
bool GainProcessorInstance::isParameterDiscrete (int parameterIndex) const
{
    assertOnceOnDeprecatedMethodUse();
...
bool GainProcessorInstance::isParameterAutomatable (int parameterIndex) const
{
    assertOnceOnDeprecatedMethodUse();
...
String GainProcessorInstance::getParameterLabel (int parameterIndex) const
{
    assertOnceOnDeprecatedMethodUse();
...
bool GainProcessorInstance::isParameterOrientationInverted (int parameterIndex) const
{
    assertOnceOnDeprecatedMethodUse();
...
bool GainProcessorInstance::isMetaParameter (int parameterIndex) const
{
    assertOnceOnDeprecatedMethodUse();
...
AudioProcessorParameter::Category GainProcessorInstance::getParameterCategory (int parameterIndex) const
{
    assertOnceOnDeprecatedMethodUse();
...
void GainProcessorInstance::assertOnceOnDeprecatedMethodUse() const noexcept
{
...
bool GainProcessorInstance::deprecationAssertiontriggered = false;

GainProcessorInstance::Parameter::Parameter()
    : onStrings  { TRANS ("on"),  TRANS ("yes"), TRANS ("true") },
      offStrings { TRANS ("off"), TRANS ("no"),  TRANS ("false") }
{
}

String GainProcessorInstance::Parameter::getText (float value, int maximumStringLength) const
{
    if (isBoolean())
...
float GainProcessorInstance::Parameter::getValueForText (const String& text) const
{
...
void GainProcessorInstance::addHostedParameter (std::unique_ptr<HostedParameter> param)
{
    addParameter (param.release());
}

void GainProcessorInstance::addHostedParameterGroup (std::unique_ptr<AudioProcessorParameterGroup> group)
{
   #if JUCE_DEBUG
...
void GainProcessorInstance::setHostedParameterTree (AudioProcessorParameterGroup group)
{
   #if JUCE_DEBUG
    // All parameters *must* be HostedParameters, otherwise getHostedParameter will return
    // garbage and your host will crash and burn
...
GainProcessorInstance::HostedParameter* GainProcessorInstance::getHostedParameter (int index) const
{
    // It's important that all GainProcessorInstance implementations
