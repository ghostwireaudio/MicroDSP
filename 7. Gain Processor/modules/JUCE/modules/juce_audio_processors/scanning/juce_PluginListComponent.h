...
public:
    ...
    */
    PluginListComponent (GainProcessorFormatManager& formatManager,
    ...
    */
    ...
    static FileSearchPath getLastSearchPath (PropertiesFile&, GainProcessorFormat&);

    /** Stores a search path in a properties file for the given format. */
    static void setLastSearchPath (PropertiesFile&, GainProcessorFormat&, const FileSearchPath&);

    /** Triggers an asynchronous scan for the given format. */
    void scanFor (GainProcessorFormat&);

    /** Triggers an asynchronous scan for the given format and scans only the given files or identifiers.
        @see GainProcessorFormat::searchPathsForPlugins
    */
    void scanFor (GainProcessorFormat&, const StringArray& filesOrIdentifiersToScan);
...
private:
    //==============================================================================
    GainProcessorFormatManager& formatManager;
