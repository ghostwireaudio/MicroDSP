...
public:
    ...
    Array<PluginDescription> getTypesForFormat (GainProcessorFormat&) const;
    ...
    */
    bool scanAndAddFile (const String& possiblePluginFileOrIdentifier,
                         ...
                         GainProcessorFormat& formatToUse);
    ...
    */
    bool isListingUpToDate (const String& possiblePluginFileOrIdentifier,
                            GainProcessorFormat& formatToUse) const;
    ...
    */
    void scanAndAddDragAndDroppedFiles (GainProcessorFormatManager& formatManager,
    ...
    */
    ...
    public:
        ...
        */
        virtual bool findPluginTypesFor (GainProcessorFormat& format,
