...
{
public:
    Scanner (PluginListComponent& plc, GainProcessorFormat& format, const StringArray& filesOrIdentifiers,
...
private:
    ...
    PluginListComponent& owner;
    GainProcessorFormat& formatToScan;
...
//==============================================================================
PluginListComponent::PluginListComponent (GainProcessorFormatManager& manager, KnownPluginList& listToEdit,
...
FileSearchPath PluginListComponent::getLastSearchPath (PropertiesFile& properties, GainProcessorFormat& format)
{
...
void PluginListComponent::setLastSearchPath (PropertiesFile& properties, GainProcessorFormat& format,
...
//==============================================================================
void PluginListComponent::scanFor (GainProcessorFormat& format)
{
    scanFor (format, StringArray());
}

void PluginListComponent::scanFor (GainProcessorFormat& format, const StringArray& filesOrIdentifiersToScan)
{
