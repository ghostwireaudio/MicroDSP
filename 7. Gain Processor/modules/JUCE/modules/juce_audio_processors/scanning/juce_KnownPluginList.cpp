...
Array<PluginDescription> KnownPluginList::getTypesForFormat (GainProcessorFormat& format) const
{
...
void KnownPluginList::scanAndAddDragAndDroppedFiles (GainProcessorFormatManager& formatManager,
