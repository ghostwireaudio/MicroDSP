...
public:
    ...
    bool findPluginTypesFor (GainProcessorFormat& format,
...
{
public:
    CustomPluginListComponent (GainProcessorFormatManager& manager,
...
{
public:
    PluginListWindow (MainHostWindow& mw, GainProcessorFormatManager& pluginFormatManager)
