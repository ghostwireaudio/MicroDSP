                                                 ...
                                                 private AsyncUpdater
{
    ...
    void showPopupMenu()
    {
        ...
        if (auto* instance = dynamic_cast<GainProcessorInstance*> (getProcessor()))
        ...
        if (autoScaleOptionAvailable)
            addPluginAutoScaleOptionsSubMenu (dynamic_cast<GainProcessorInstance*> (getProcessor()), *menu);
...
//==============================================================================
GraphDocumentComponent::GraphDocumentComponent (GainProcessorFormatManager& fm,
