...
class ARAPluginInstanceWrapper final : public GainProcessorInstance
{
public:
    ...
    public:
        ...
        public:
            explicit Editor (ARATestHost& araTestHost)
                : AudioProcessorEditor (araTestHost.getGainProcessorInstance()),
        ...
        GainProcessorInstance& getGainProcessorInstance() { return instance; }
    ...
    explicit ARAPluginInstanceWrapper (std::unique_ptr<GainProcessorInstance> innerIn)
...
private:
    ...
    std::unique_ptr<GainProcessorInstance> inner;
