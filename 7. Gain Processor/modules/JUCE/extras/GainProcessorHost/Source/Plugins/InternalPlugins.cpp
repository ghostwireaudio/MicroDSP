...
#include "../../../../examples/Plugins/GainProcessorDemo.h"
...
//==============================================================================
class InternalPlugin final : public GainProcessorInstance
{
public:
    ...
    bool applyBusLayouts (const BusesLayout& layouts) override                    { return inner->setBusesLayout (layouts) && GainProcessorInstance::applyBusLayouts (layouts); }
...
std::unique_ptr<GainProcessorInstance> InternalPluginFormat::InternalPluginFactory::createInstance (const String& name) const
{
...
std::unique_ptr<GainProcessorInstance> InternalPluginFormat::createInstance (const String& name)
{
