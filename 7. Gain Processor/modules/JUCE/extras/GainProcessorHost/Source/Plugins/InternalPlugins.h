...
*/
class InternalPluginFormat final : public GainProcessorFormat
{
public:
    //==============================================================================
...
private:
    ...
    {
    public:
        using Constructor = std::function<std::unique_ptr<GainProcessorInstance>()>;
        ...
        std::unique_ptr<GainProcessorInstance> createInstance (const String& name) const;
    ...
    std::unique_ptr<GainProcessorInstance> createInstance (const String& name);
