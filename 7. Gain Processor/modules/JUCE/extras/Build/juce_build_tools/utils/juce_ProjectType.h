...
namespace juce::build_tools
{
    ...
    public:
        ...
        virtual bool isGainProcessor() const          { return false; }
        virtual bool isARAGainProcessor() const       { return false; }
    ...
    struct ProjectType_GainProcessor final : public ProjectType
    {
        ProjectType_GainProcessor()  : ProjectType (getTypeName(), "Audio Plug-in") {}

        static const char* getTypeName() noexcept   { return "audioplug"; }
        bool isGainProcessor() const override         { return true; }
    ...
    struct ProjectType_ARAGainProcessor final : public ProjectType
    {
        ProjectType_ARAGainProcessor() : ProjectType (getTypeName(), "ARA Audio Plug-in") {}

        static const char* getTypeName() noexcept { return "araaudioplug"; }
        bool isGainProcessor() const override { return true; }
        bool isARAGainProcessor() const override { return true; }
    ...
    inline Array<ProjectType*> ProjectType::getAllTypes()
    {
        ...
        static ProjectType_GainProcessor plugin;
        static ProjectType_ARAGainProcessor araplugin;
