    ...
    inline std::vector<ProjectTemplate> getAllTemplates()
    {
        return
        {
            ...
            { ProjectCategory::plugin,
              ...
              build_tools::ProjectType_GainProcessor::getTypeName(),
              BinaryData::wizard_GainProcessor_svg,
              getModulesRequiredForAudioProcessor(),
              {
                { FileCreationOptions::processorAndEditor, { { "PluginProcessor.cpp", "jucer_GainProcessorFilterTemplate_cpp" },
                                                             { "PluginProcessor.h",   "jucer_GainProcessorFilterTemplate_h" },
                                                             { "PluginEditor.cpp",    "jucer_GainProcessorEditorTemplate_cpp" },
                                                             { "PluginEditor.h",      "jucer_GainProcessorEditorTemplate_h" } } }
              },
            ...
            { ProjectCategory::plugin,
              ...
              build_tools::ProjectType_ARAGainProcessor::getTypeName(),
              BinaryData::wizard_GainProcessor_svg,
              getModulesRequiredForAudioProcessor(),
              {
                  { FileCreationOptions::araPluginFiles, { { "PluginProcessor.cpp",               "jucer_GainProcessorFilterTemplate_cpp" },
                                                           { "PluginProcessor.h",                 "jucer_GainProcessorARAFilterTemplate_h" },
                                                           { "PluginEditor.cpp",                  "jucer_GainProcessorARAEditorTemplate_cpp" },
                                                           { "PluginEditor.h",                    "jucer_GainProcessorARAEditorTemplate_h" },
                                                           { "PluginARADocumentController.cpp",   "jucer_GainProcessorARADocumentControllerTemplate_cpp" },
                                                           { "PluginARADocumentController.h",     "jucer_GainProcessorARADocumentControllerTemplate_h" },
                                                           { "PluginARAPlaybackRenderer.cpp",     "jucer_GainProcessorARAPlaybackRendererTemplate_cpp" },
                                                           { "PluginARAPlaybackRenderer.h",       "jucer_GainProcessorARAPlaybackRendererTemplate_h" }} }
              },
