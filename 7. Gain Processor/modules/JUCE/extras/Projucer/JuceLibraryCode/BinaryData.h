...
namespace BinaryData
{
    ...
    extern const char*   wizard_GainProcessor_svg;
    const int            wizard_GainProcessor_svgSize = 21296;
    ...
    extern const char*   jucer_GainProcessorARADocumentControllerTemplate_cpp;
    const int            jucer_GainProcessorARADocumentControllerTemplate_cppSize = 1916;

    extern const char*   jucer_GainProcessorARADocumentControllerTemplate_h;
    const int            jucer_GainProcessorARADocumentControllerTemplate_hSize = 1445;

    extern const char*   jucer_GainProcessorARAEditorTemplate_cpp;
    const int            jucer_GainProcessorARAEditorTemplate_cppSize = 1613;

    extern const char*   jucer_GainProcessorARAEditorTemplate_h;
    const int            jucer_GainProcessorARAEditorTemplate_hSize = 1142;

    extern const char*   jucer_GainProcessorARAFilterTemplate_h;
    const int            jucer_GainProcessorARAFilterTemplate_hSize = 2462;

    extern const char*   jucer_GainProcessorARAPlaybackRendererTemplate_cpp;
    const int            jucer_GainProcessorARAPlaybackRendererTemplate_cppSize = 5322;

    extern const char*   jucer_GainProcessorARAPlaybackRendererTemplate_h;
    const int            jucer_GainProcessorARAPlaybackRendererTemplate_hSize = 1757;

    extern const char*   jucer_GainProcessorEditorTemplate_cpp;
    const int            jucer_GainProcessorEditorTemplate_cppSize = 1375;

    extern const char*   jucer_GainProcessorEditorTemplate_h;
    const int            jucer_GainProcessorEditorTemplate_hSize = 973;

    extern const char*   jucer_GainProcessorFilterTemplate_cpp;
    const int            jucer_GainProcessorFilterTemplate_cppSize = 6218;

    extern const char*   jucer_GainProcessorFilterTemplate_h;
    const int            jucer_GainProcessorFilterTemplate_hSize = 2299;
